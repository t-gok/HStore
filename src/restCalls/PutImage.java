...
import hbs.HbsUtil;
import hbs.ImageInfo;
import hbs.ImportImage;
...
public class PutImage extends HttpServlet{
	...
	HbsUtil util = new HbsUtil();
		...
		public void doPut(HttpServletRequest request, HttpServletResponse response) {
			...
			ImageInfo imageInfo = new ImageInfo(imageKey, lenOfFile);	
			String responseMessage = "";
			try {
				ServletInputStream fsIn = request.getInputStream();
				ImportImage impImage = new ImportImage();
				responseMessage += impImage.importImage(fsIn, imageInfo);

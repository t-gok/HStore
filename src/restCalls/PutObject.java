	...
	HbsUtil util = new HbsUtil();
		...
		public void doPut(HttpServletRequest request, HttpServletResponse response) {
			...
			try {
				...
				responseMessage += HadoopObjectStore.getHadoopObjectStore().PutObject(new BucketInfo(new UserId(userName),bucketKey), objectInfo, fsIn);

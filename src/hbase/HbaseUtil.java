...
//
	...
	public static ArrayList<Result> getResultsForPrefix(String tableName, String prefixString){
		ArrayList<Result> ret = new ArrayList<Result>();
		try {
	...
	public static ArrayList<Result> getResultsContaining(String tableName, String containingString){
		ArrayList<Result> ret = new ArrayList<Result>();
		try {
			HTable table = new HTable(con, tableName);
			byte[] contains = Bytes.toBytes(containingString);
			Scan scan = new Scan(contains);
			Filter containsFilter = new RowFilter(CompareOp.EQUAL, new SubstringComparator(containingString));
